...
XLABEL = "Max CFR using 3 methods (hours)"
...
def gen_plot(cdfs, labels, out_file, show_plot=False):
    ...
    with mpl.rc_context(options.get_basic_conf()):
        ...
        ax.set(xlabel=XLABEL, xlim=(-1, 36), ylabel="CDF")
...
def main(config):
    ...
    outs = [
        "../../data/text/ranks-max-cfr-stats.txt",
        "../../data/text/bootstrap-max-cfr-stats.txt",
        "../../data/text/hmm-max-cfr-stats.txt",
    ]
...
if __name__ == "__main__":
    ...
    config = {
        ...
        "column_stats_map": {  # Mapping of columns to stats file paths
            "ranks_max_cfr": "../../data/csv/num-statistics.csv",
            "bootstrap_max_cfr": "../../data/csv/num-statistics.csv",
            "hmm_max_cfr": "../../data/csv/num-statistics.csv",
        },
        "plot_file": "../../data/plots/max-cfr-cdf.pdf",  # Output PDF file
