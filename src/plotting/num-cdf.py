...
XLABEL = "Number of change points using 3 methods"
...
def main(config):
    ...
    outs = [
        "../../data/text/ranks-num-stats.txt",
        "../../data/text/bootstrap-num-stats.txt",
        "../../data/text/hmm-num-stats.txt",
    ]
...
if __name__ == "__main__":
    ...
    config = {
        ...
        "column_stats_map": {  # Mapping of columns to stats file paths
            "ranks_num": "../../data/csv/num-statistics.csv",
            "bootstrap_num": "../../data/csv/num-statistics.csv",
            "hmm_num": "../../data/csv/num-statistics.csv",
        },
        "plot_file": "../../data/plots/num-cdf.pdf",  # Output PDF file
